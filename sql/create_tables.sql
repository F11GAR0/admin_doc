...
create table external_users (
	...
	id_user int references users on delete cascade,
	email varchar(64),
	password_hash varchar(64)
);
commit;
...
create table user_devices (
	...
	id_user int references users on delete cascade,
	id_device int references devices on delete cascade
);
commit;
...
create table user_permissions (
	...
	id_user int references users on delete cascade,
	id_role int references roles on delete cascade
);
commit;
...
create table user_services (
	...
	id_user int references users on delete cascade,
	id_service int references services on delete cascade
);
commit;
